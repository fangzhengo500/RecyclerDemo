package com.loosu.recyclerdemo.widget.dialog;
...
import com.loosu.recyclerdemo.adapter.ReportDialogTypeItemAdapter;
import com.loosu.recyclerdemo.adapter.base.recyclerview.IRecyclerItemClickListener;
...
public class ReportDialog extends DialogFragment implements View.OnClickListener, IRecyclerItemClickListener {
    ...
    private void initView(View rootView, Bundle savedInstanceState) {
        mViewList.setLayoutManager(new GridLayoutManager(getContext(), 4));
    ...
    private void onClickBtnSubmit() {
        if (mListener != null) {
            //int checkedId = mRgReportReason.getCheckedRadioButtonId();
            //Item item = findItemById(checkedId);
